...
extension Illuminant {
    ...
    public static var rgbPrimaries: [ColorSpaceType.RGB: ColorElement.Matrix] = [
        .unknown:            .init([0.6400, 0.3300, 0.3000, 0.6000, 0.1500, 0.0600], 3, 2),
        .sRGB:               .init([0.6400, 0.3300, 0.3000, 0.6000, 0.1500, 0.0600], 3, 2),
        .AppleRGB:           .init([0.6250, 0.3400, 0.2800, 0.5950, 0.1550, 0.0700], 3, 2),
        .AdobeRGB:           .init([0.6400, 0.3300, 0.2100, 0.7100, 0.1500, 0.0600], 3, 2),
        .BT2020RGB:          .init([0.7080, 0.2920, 0.1700, 0.7970, 0.1310, 0.0460], 3, 2),
        .BT709RGB:           .init([0.6400, 0.3300, 0.3000, 0.6000, 0.1500, 0.0600], 3, 2),
        .DCIP3RGB:           .init([0.6800, 0.3200, 0.2650, 0.6900, 0.1500, 0.0600], 3, 2),
        .DCIP3PRGB:          .init([0.7400, 0.2700, 0.2200, 0.7800, 0.0900, -0.0900], 3, 2),
        .DisplayP3RGB:       .init([0.6800, 0.3200, 0.2650, 0.6900, 0.1500, 0.0600], 3, 2),
        .CIERGB:             .init([0.734742840005998, 0.265257159994002, 0.273779033824958, 0.717477700256116, 0.166555629580280, 0.008910726182545], 3, 2),
        .AdobeWideGamutRGB:  .init([0.7347, 0.2653, 0.1152, 0.8264, 0.1566, 0.0177], 3, 2)
    ]
